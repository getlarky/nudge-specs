...
#                       DESC
  ...
  s.author           = { 'mcgarveymobile' => 'mcgarveymobile@gmail.com' }
  s.source           = { :http => 'https://github.com/getlarky/nudge-specs/releases/download/1.4.0-staging/nudge.zip' }
